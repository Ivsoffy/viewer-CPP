...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_OGLwidget_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_OGLwidget_t qt_meta_stringdata_OGLwidget = {
    {
QT_MOC_LITERAL(0, 9) // "OGLwidget"
...
const QMetaObject OGLwidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_OGLwidget.offsetsAndSize,
    qt_meta_data_OGLwidget,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_OGLwidget_t
, QtPrivate::TypeAndForceComplete<OGLwidget, std::true_type>
