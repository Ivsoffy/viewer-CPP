...
public:
    ...
    QSpinBox *intSpinBox_settings_move_rotate_x;
...
""));
        ...
        intSpinBox_settings_move_rotate_x = new QSpinBox(frame_settings_move_rotate);
        intSpinBox_settings_move_rotate_x->setObjectName(QString::fromUtf8("intSpinBox_settings_move_rotate_x"));
        intSpinBox_settings_move_rotate_x->setGeometry(QRect(50, 30, 101, 31));
        intSpinBox_settings_move_rotate_x->setLayoutDirection(Qt::LeftToRight);
        intSpinBox_settings_move_rotate_x->setStyleSheet(QString::fromUtf8("border: 1px  solid rgb(150, 150, 150) ;\n"
"background-color: rgb(50, 50, 50);\n"
"\n"
" \n"
""));
        intSpinBox_settings_move_rotate_x->setInputMethodHints(Qt::ImhFormattedNumbersOnly);
        intSpinBox_settings_move_rotate_x->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);
        intSpinBox_settings_move_rotate_x->setMaximum(360);
...
""));
        ...
        doubleSpinBox_settings_move_rotate_x = new QDoubleSpinBox(centralwidget);
        doubleSpinBox_settings_move_rotate_x->setObjectName(QString::fromUtf8("doubleSpinBox_settings_move_rotate_x"));
        doubleSpinBox_settings_move_rotate_x->setGeometry(QRect(220, 450, 110, 31));
        QPalette palette;
...
#endif
        doubleSpinBox_settings_move_rotate_x->setPalette(palette);
...
""));
        ...
        doubleSpinBox_settings_move_rotate_x->setMinimum(0.000000000000000);
        doubleSpinBox_settings_move_rotate_x->setMaximum(360.000000000000000);
        doubleSpinBox_settings_move_rotate_x->setSingleStep(1.000000000000000);
