...
public:
    ...
    QSlider *slider_scale_3;
    QSpinBox *spinbox_scale_3;
    QMenuBar *menubar;
...
""));
        ...
        slider_scale->setGeometry(QRect(10, 460, 91, 31));
        slider_scale->setMinimum(0);
        slider_scale->setMaximum(1000);
        slider_scale->setSingleStep(1);
        slider_scale->setValue(1000);
        slider_scale->setSliderPosition(1000);
        ...
        spinbox_scale_2->setGeometry(QRect(200, 450, 81, 22));
        spinbox_scale_2->setMinimum(-100);
        spinbox_scale_2->setMaximum(200);
        spinbox_scale_2->setSingleStep(1);
        spinbox_scale_2->setValue(0);
        spinbox_scale = new QDoubleSpinBox(centralwidget);
        spinbox_scale->setObjectName(QString::fromUtf8("spinbox_scale"));
        spinbox_scale->setGeometry(QRect(50, 440, 62, 22));
        spinbox_scale->setMaximum(1000.000000000000000);
        spinbox_scale->setSingleStep(0.100000000000000);
        spinbox_scale->setValue(100.000000000000000);
        slider_scale_2 = new QSlider(centralwidget);
        slider_scale_2->setObjectName(QString::fromUtf8("slider_scale_2"));
        slider_scale_2->setGeometry(QRect(100, 480, 221, 31));
        slider_scale_2->setMinimum(-100);
        slider_scale_2->setMaximum(100);
        ...
        slider_scale_3 = new QSlider(centralwidget);
        slider_scale_3->setObjectName(QString::fromUtf8("slider_scale_3"));
        slider_scale_3->setGeometry(QRect(330, 490, 241, 31));
        slider_scale_3->setMinimum(0);
        slider_scale_3->setMaximum(1000000);
        slider_scale_3->setSingleStep(1);
        slider_scale_3->setValue(10000);
        slider_scale_3->setSliderPosition(10000);
        slider_scale_3->setOrientation(Qt::Horizontal);
        spinbox_scale_3 = new QSpinBox(centralwidget);
        spinbox_scale_3->setObjectName(QString::fromUtf8("spinbox_scale_3"));
        spinbox_scale_3->setGeometry(QRect(380, 460, 81, 22));
        spinbox_scale_3->setMinimum(0);
        spinbox_scale_3->setMaximum(1000000);
        spinbox_scale_3->setSingleStep(1);
        spinbox_scale_3->setValue(10000);
