...
""));
        ...
        slider_scale->setGeometry(QRect(10, 480, 371, 31));
        slider_scale->setMinimum(0);
        slider_scale->setMaximum(1000);
        slider_scale->setSingleStep(1);
        slider_scale->setValue(100);
        slider_scale->setSliderPosition(100);
        slider_scale->setOrientation(Qt::Horizontal);
        spinbox_scale_22 = new QSpinBox(centralwidget);
        spinbox_scale_22->setObjectName(QString::fromUtf8("spinbox_scale_22"));
        spinbox_scale_22->setGeometry(QRect(270, 440, 101, 22));
        spinbox_scale_22->setMinimum(-100);
        spinbox_scale_22->setMaximum(300);
        spinbox_scale_22->setSingleStep(1);
        spinbox_scale_22->setValue(0);
