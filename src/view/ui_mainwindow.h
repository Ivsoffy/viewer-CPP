...
""));
        ...
        spinbox_scale = new QSpinBox(centralwidget);
        spinbox_scale->setObjectName(QString::fromUtf8("spinbox_scale"));
        spinbox_scale->setGeometry(QRect(410, 440, 81, 22));
        spinbox_scale->setMinimum(-100);
        spinbox_scale->setMaximum(200);
        spinbox_scale->setSingleStep(1);
        spinbox_scale->setValue(0);
        slider_scale = new QSlider(centralwidget);
        slider_scale->setObjectName(QString::fromUtf8("slider_scale"));
        slider_scale->setGeometry(QRect(330, 470, 221, 31));
