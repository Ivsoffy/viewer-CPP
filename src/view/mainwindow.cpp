...
void MainWindow::rebuff() {
  ...
  s21::GLBufferDTO GLBuffDTO = controller_->TransferGLBuffer();//это все за 240ms
...
void MainWindow::on_intSpinBox_settings_move_rotate_x_valueChanged(//////////////////////////////////
    int arg) {
//  ui->openGLWidget->rot_x = arg;// --
  ui->horizontalSlider_settings_move_rotate_x->setValue((double)arg);
  changeXangle(arg);
}
